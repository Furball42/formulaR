...
{
    public abstract class FormulaRWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FormulaRWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FormulaRWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FormulaRDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FormulaRDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FormulaRDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FormulaRDbContext, Task<T>> func)
        {
            T result;
