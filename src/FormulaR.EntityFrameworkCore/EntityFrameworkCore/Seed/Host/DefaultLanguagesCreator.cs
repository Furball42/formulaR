...
namespace FormulaR.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly FormulaRDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = FormulaRConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(FormulaRDbContext context)
        {
            _context = context;
        }
